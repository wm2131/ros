...
void doneCb(const actionlib::SimpleClientGoalState& state, const beginner_tutorials::DoDishesResultConstPtr& result)
{
...
// 收到feedback后调用的回调函数
void feedbackCb(const beginner_tutorials::DoDishesFeedbackConstPtr& feedback)
{
